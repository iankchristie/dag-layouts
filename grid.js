...
export const updateGrid = function (graph) {
  document.getElementById("grid-container").innerHTML = `<svg id="grid-svg">
    <g id="grid-zoom-layer" "transform="translate(2, 2)">
      <defs id="defs" />
      <g id="links" />
      <g id="nodes" />
      <g id="arrows" />
  ...
  const zoom = d3
    ...
    .on("zoom", function zoomed(e) {
      d3.select("#grid-zoom-layer").attr("transform", e.transform);
    });
