...
export const updateZherebko = function (graph) {
  document.getElementById(
    "zherebko-container"
  ).innerHTML = `<svg id="zherebko-svg">
    <g id="zherebko-zoom-layer" "transform="translate(2, 2)">
      <defs id="defs" />
      <g id="links" />
      <g id="nodes" />
      <g id="arrows" />
  ...
  const zoom = d3
    ...
    .on("zoom", function zoomed(e) {
      d3.select("#zherebko-zoom-layer").attr("transform", e.transform);
    });
