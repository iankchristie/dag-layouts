...
function blurfImage(radius) {
  ...
  return (T, S, start4, stop, step) => {
    start4 <<= 2, stop <<= 2, step <<= 2;
    blur3(T, S, start4 + 0, stop + 0, step);
    blur3(T, S, start4 + 1, stop + 1, step);
    blur3(T, S, start4 + 2, stop + 2, step);
    blur3(T, S, start4 + 3, stop + 3, step);
  };
}
function blurf(radius) {
  ...
  return (T, S, start4, stop, step) => {
    if (!((stop -= step) >= start4))
      return;
    let sum4 = radius0 * S[start4];
    const s0 = step * radius0;
    const s1 = s0 + step;
    for (let i = start4, j = start4 + s0; i < j; i += step) {
      sum4 += S[Math.min(stop, i)];
    }
    for (let i = start4, j = stop; i <= j; i += step) {
      sum4 += S[Math.min(stop, i + s0)];
      T[i] = (sum4 + t * (S[Math.max(start4, i - s1)] + S[Math.min(stop, i + s1)])) / w;
      sum4 -= S[Math.max(start4, i - s0)];
    }
  };
}
function bluri(radius) {
  ...
  return (T, S, start4, stop, step) => {
    if (!((stop -= step) >= start4))
      return;
    let sum4 = radius * S[start4];
    const s2 = step * radius;
    for (let i = start4, j = start4 + s2; i < j; i += step) {
      sum4 += S[Math.min(stop, i)];
    }
    for (let i = start4, j = stop; i <= j; i += step) {
      sum4 += S[Math.min(stop, i + s2)];
      T[i] = sum4 / w;
      sum4 -= S[Math.max(start4, i - s2)];
    }
  };
}
...
var e5 = Math.sqrt(10);
var e2 = Math.sqrt(2);
function tickSpec(start4, stop, count3) {
  const step = (stop - start4) / Math.max(0, count3), power = Math.floor(Math.log10(step)), error = step / Math.pow(10, power), factor = error >= e10 ? 10 : error >= e5 ? 5 : error >= e2 ? 2 : 1;
  let i1, i2, inc2;
  if (power < 0) {
    inc2 = Math.pow(10, -power) / factor;
    i1 = Math.round(start4 * inc2);
  ...
  if (i2 < i1 && 0.5 <= count3 && count3 < 2)
    return tickSpec(start4, stop, count3 * 2);
  return [i1, i2, inc2];
}
function ticks(start4, stop, count3) {
  stop = +stop, start4 = +start4, count3 = +count3;
  if (!(count3 > 0))
    return [];
  if (start4 === stop)
    return [start4];
  const reverse2 = stop < start4, [i1, i2, inc2] = reverse2 ? tickSpec(stop, start4, count3) : tickSpec(start4, stop, count3);
  if (!(i2 >= i1))
    return [];
...
function tickIncrement(start4, stop, count3) {
  stop = +stop, start4 = +start4, count3 = +count3;
  return tickSpec(start4, stop, count3)[2];
}
function tickStep(start4, stop, count3) {
  stop = +stop, start4 = +start4, count3 = +count3;
  const reverse2 = stop < start4, inc2 = reverse2 ? tickIncrement(stop, start4, count3) : tickIncrement(start4, stop, count3);
  return (reverse2 ? -1 : 1) * (inc2 < 0 ? 1 / -inc2 : inc2);
}

// node_modules/d3-array/src/nice.js
function nice(start4, stop, count3) {
  let prestep;
  while (true) {
    const step = tickIncrement(start4, stop, count3);
...
function range(start4, stop, step) {
  start4 = +start4, stop = +stop, step = (n = arguments.length) < 2 ? (stop = start4, start4 = 0, 1) : n < 3 ? 1 : +step;
  var i = -1, n = Math.max(0, Math.ceil((stop - start4) / step)) | 0, range4 = new Array(n);
  while (++i < n) {
    range4[i] = start4 + i * step;
  }
  return range4;
}
...
function nodrag_default(view) {
  var root5 = view.document.documentElement, selection4 = select_default2(view).on("dragstart.drag", noevent_default, nonpassivecapture);
...
var rgb_default = function rgbGamma(y4) {
  ...
  function rgb2(start4, end) {
    var r = color2((start4 = rgb(start4)).r, (end = rgb(end)).r), g = color2(start4.g, end.g), b = color2(start4.b, end.b), opacity = nogamma(start4.opacity, end.opacity);
    return function(t) {
      start4.r = r(t);
      start4.g = g(t);
      start4.b = b(t);
...
function hsl2(hue2) {
  return function(start4, end) {
    var h = hue2((start4 = hsl(start4)).h, (end = hsl(end)).h), s2 = nogamma(start4.s, end.s), l = nogamma(start4.l, end.l), opacity = nogamma(start4.opacity, end.opacity);
    return function(t) {
      start4.h = h(t);
      start4.s = s2(t);
      start4.l = l(t);
...
function lab2(start4, end) {
  var l = nogamma((start4 = lab(start4)).l, (end = lab(end)).l), a4 = nogamma(start4.a, end.a), b = nogamma(start4.b, end.b), opacity = nogamma(start4.opacity, end.opacity);
  return function(t) {
    start4.l = l(t);
    start4.a = a4(t);
    start4.b = b(t);
...
function hcl2(hue2) {
  return function(start4, end) {
    var h = hue2((start4 = hcl(start4)).h, (end = hcl(end)).h), c6 = nogamma(start4.c, end.c), l = nogamma(start4.l, end.l), opacity = nogamma(start4.opacity, end.opacity);
    return function(t) {
      start4.h = h(t);
      start4.c = c6(t);
      start4.l = l(t);
...
function cubehelix2(hue2) {
  return function cubehelixGamma(y4) {
    y4 = +y4;
    function cubehelix3(start4, end) {
      var h = hue2((start4 = cubehelix(start4)).h, (end = cubehelix(end)).h), s2 = nogamma(start4.s, end.s), l = nogamma(start4.l, end.l), opacity = nogamma(start4.opacity, end.opacity);
      return function(t) {
        start4.h = h(t);
        start4.s = s2(t);
        start4.l = l(Math.pow(t, y4));
        start4.opacity = opacity(t);
        return start4 + "";
      };
    }
...
var ENDING = 5;
var ENDED = 6;
function schedule_default(node, name, id4, index3, group2, timing) {
...
function tweenRemove(id4, name) {
  var tween0, tween1;
  return function() {
    var schedule = set3(this, id4), tween = schedule.tween;
    if (tween !== tween0) {
      tween1 = tween0 = tween;
...
function durationFunction(id4, value) {
  return function() {
    set3(this, id4).duration = +value.apply(this, arguments);
  };
}
function durationConstant(id4, value) {
  return value = +value, function() {
    set3(this, id4).duration = value;
  };
}
...
function merge_default2(transition4) {
  if (transition4._id !== this._id)
    throw new Error();
  for (var groups0 = this._groups, groups1 = transition4._groups, m0 = groups0.length, m1 = groups1.length, m3 = Math.min(m0, m1), merges = new Array(m0), j = 0; j < m3; ++j) {
    for (var group0 = groups0[j], group1 = groups1[j], n = group0.length, merge2 = merges[j] = new Array(n), node, i = 0; i < n; ++i) {
      if (node = group0[i] || group1[i]) {
        merge2[i] = node;
      }
...
function selectAll_default3(select) {
  ...
  for (var groups2 = this._groups, m3 = groups2.length, subgroups = [], parents = [], j = 0; j < m3; ++j) {
    for (var group2 = groups2[j], n = group2.length, node, i = 0; i < n; ++i) {
      if (node = group2[i]) {
        for (var children4 = select.call(node, node.__data__, i, group2), child, inherit4 = get2(node, id4), k2 = 0, l = children4.length; k2 < l; ++k2) {
          if (child = children4[k2]) {
            schedule_default(child, name, id4, k2, children4, inherit4);
          }
        }
...
function styleMaybeRemove(id4, name) {
  ...
  return function() {
    var schedule = set3(this, id4), on = schedule.on, listener = schedule.value[key] == null ? remove4 || (remove4 = styleRemove2(name)) : void 0;
...
function end_default() {
  ...
  return new Promise(function(resolve, reject) {
    ...
    that.each(function() {
      var schedule = set3(this, id4), on = schedule.on;
      if (on !== on0) {
        on1 = (on0 = on).copy();
...
var id = 0;
function Transition(groups2, parents, name, id4) {
  this._groups = groups2;
  this._parents = parents;
  this._name = name;
  this._id = id4;
...
function transition_default2(name) {
  ...
  for (var groups2 = this._groups, m3 = groups2.length, j = 0; j < m3; ++j) {
    for (var group2 = groups2[j], n = group2.length, node, i = 0; i < n; ++i) {
      if (node = group2[i]) {
        schedule_default(node, name, id4, i, group2, timing || inherit(node, id4));
      }
    }
  }
  return new Transition(groups2, this._parents, name, id4);
}
...
function brush(dim) {
  ...
  function redraw() {
    var group2 = select_default2(this), selection4 = local2(this).selection;
    if (selection4) {
...
function contours_default() {
  ...
  function isorings(values, value, callback) {
    ...
    function stitch(line) {
      var start4 = [line[0][0] + x4, line[0][1] + y4], end = [line[1][0] + x4, line[1][1] + y4], startIndex = index3(start4), endIndex = index3(end), f, g;
      if (f = fragmentByEnd[startIndex]) {
        ...
        fragmentByStart[startIndex] = fragmentByEnd[endIndex] = { start: startIndex, end: endIndex, ring: [start4, end] };
      }
    }
  }
  ...
  update() {
    ...
    for (let k2 = 0, xp, yp; k2 < this._ids.length; k2++) {
      ...
      for (let j = 0, key = this._hashKey(x4, y4); j < this._hashSize; j++) {
        start4 = hullHash[(key + j) % this._hashSize];
        if (start4 !== -1 && start4 !== hullNext[start4])
          break;
      }
...
function selectAll_default5(selector) {
  return typeof selector === "string" ? new Selection3([document.querySelectorAll(selector)], [document.documentElement]) : new Selection3([array4(selector)], root2);
}
...
function nodrag_default2(view) {
  var root5 = view.document.documentElement, selection4 = select_default5(view).on("dragstart.drag", noevent_default3, nonpassivecapture2);
  if ("onselectstart" in root5) {
    selection4.on("selectstart.drag", noevent_default3, nonpassivecapture2);
  } else {
    root5.__noselect = root5.style.MozUserSelect;
    root5.style.MozUserSelect = "none";
  }
...
function yesdrag2(view, noclick) {
  ...
  if (noclick) {
    selection4.on("click.drag", noevent_default3, nonpassivecapture2);
    setTimeout(function() {
      selection4.on("click.drag", null);
    }, 0);
  }
...
function drag_default2() {
  var filter5 = defaultFilter2, container = defaultContainer, subject = defaultSubject, touchable = defaultTouchable2, gestures = {}, listeners = dispatch_default3("start", "drag", "end"), active = 0, mousedownx, mousedowny, mousemoving, touchending, clickDistance2 = 0;
  function drag(selection4) {
    selection4.on("mousedown.drag", mousedowned).filter(touchable).on("touchstart.drag", touchstarted).on("touchmove.drag", touchmoved, nonpassive2).on("touchend.drag touchcancel.drag", touchended).style("touch-action", "none").style("-webkit-tap-highlight-color", "rgba(0,0,0,0)");
  }
  ...
  function beforestart(that, container2, event, d, identifier, touch) {
    var dispatch3 = listeners.copy(), p = pointer_default2(touch || event, container2), dx, dy, s2;
  ...
  drag.filter = function(_) {
    return arguments.length ? (filter5 = typeof _ === "function" ? _ : constant_default8(!!_), drag) : filter5;
  };
  drag.container = function(_) {
    return arguments.length ? (container = typeof _ === "function" ? _ : constant_default8(_), drag) : container;
  };
  drag.subject = function(_) {
    return arguments.length ? (subject = typeof _ === "function" ? _ : constant_default8(_), drag) : subject;
  };
  drag.touchable = function(_) {
    return arguments.length ? (touchable = typeof _ === "function" ? _ : constant_default8(!!_), drag) : touchable;
  };
  drag.on = function() {
    var value = listeners.on.apply(listeners, arguments);
...
function dsvParse(parse) {
  return function(input, init4, row) {
    if (arguments.length === 2 && typeof init4 === "function")
      row = init4, init4 = void 0;
...
function dsv(delimiter, input, init4, row) {
  if (arguments.length === 3 && typeof init4 === "function")
    row = init4, init4 = void 0;
...
function parser(type2) {
  return (input, init4) => text_default4(input, init4).then((text) => new DOMParser().parseFromString(text, type2));
}
...
function collide_default(radius) {
  ...
  if (typeof radius !== "function")
    radius = constant_default9(radius == null ? 1 : +radius);
  function force() {
  ...
  force.radius = function(_) {
    return arguments.length ? (radius = typeof _ === "function" ? _ : constant_default9(+_), initialize(), force) : radius;
  };
  return force;
}
...
function link_default(links) {
  var id4 = index2, strength = defaultStrength, strengths, distance = constant_default9(30), distances, nodes, count3, bias, random, iterations2 = 1;
  if (links == null)
    links = [];
  ...
  function initialize() {
    if (!nodes)
      return;
    var i, n = nodes.length, m3 = links.length, nodeById = new Map(nodes.map((d, i2) => [id4(d, i2, nodes), d])), link3;
  ...
  force.strength = function(_) {
    return arguments.length ? (strength = typeof _ === "function" ? _ : constant_default9(+_), initializeStrength(), force) : strength;
  };
  force.distance = function(_) {
    return arguments.length ? (distance = typeof _ === "function" ? _ : constant_default9(+_), initializeDistance(), force) : distance;
  };
  return force;
}
...
function manyBody_default() {
  var nodes, node, random, alpha, strength = constant_default9(-30), strengths, distanceMin2 = 1, distanceMax2 = Infinity, theta2 = 0.81;
  function force(_) {
  ...
  force.strength = function(_) {
    return arguments.length ? (strength = typeof _ === "function" ? _ : constant_default9(+_), initialize(), force) : strength;
  };
...
function radial_default(radius, x4, y4) {
  var nodes, strength = constant_default9(0.1), strengths, radiuses;
  if (typeof radius !== "function")
    radius = constant_default9(+radius);
  if (x4 == null)
    x4 = 0;
  if (y4 == null)
    y4 = 0;
...
function x_default2(x4) {
  var strength = constant_default9(0.1), nodes, strengths, xz;
  if (typeof x4 !== "function")
    x4 = constant_default9(x4 == null ? 0 : +x4);
  function force(alpha) {
    for (var i = 0, n = nodes.length, node; i < n; ++i) {
  ...
  force.x = function(_) {
    return arguments.length ? (x4 = typeof _ === "function" ? _ : constant_default9(+_), initialize(), force) : x4;
  };
  return force;
}
...
function y_default2(y4) {
  var strength = constant_default9(0.1), nodes, strengths, yz;
  if (typeof y4 !== "function")
    y4 = constant_default9(y4 == null ? 0 : +y4);
  function force(alpha) {
    for (var i = 0, n = nodes.length, node; i < n; ++i) {
  ...
  force.y = function(_) {
    return arguments.length ? (y4 = typeof _ === "function" ? _ : constant_default9(+_), initialize(), force) : y4;
  };
  return force;
}
...
function circle_default() {
  var center2 = constant_default10([0, 0]), radius = constant_default10(90), precision = constant_default10(6), ring, rotate, stream = { point: point6 };
...
function rejoin_default(segments, compareIntersection2, startInside, interpolate, stream) {
  ...
  var start4 = subject[0], points, point6;
  while (1) {
...
function stratify_default() {
  var id4 = defaultId, parentId = defaultParentId, path3;
  function stratify(data) {
    var nodes = Array.from(data), currentId = id4, currentParentId = parentId, n, d, i, root5, parent, node, nodeId, nodeKey, nodeByKey = /* @__PURE__ */ new Map();
    if (path3 != null) {
  ...
  stratify.id = function(x4) {
    return arguments.length ? (id4 = optional(x4), stratify) : id4;
  };
...
function band() {
  ...
  function rescale() {
    var n = domain().length, reverse2 = r1 < r0, start4 = reverse2 ? r1 : r0, stop = reverse2 ? r0 : r1;
    ...
    if (round)
      start4 = Math.round(start4), bandwidth = Math.round(bandwidth);
...
function tickFormat(start4, stop, count3, specifier) {
  var step = tickStep(start4, stop, count3), precision;
  ...
  switch (specifier.type) {
    ...
    case "p":
    case "r": {
      if (specifier.precision == null && !isNaN(precision = precisionRound_default(step, Math.max(Math.abs(start4), Math.abs(stop)))))
...
function linearish(scale2) {
  ...
  scale2.nice = function(count3) {
    ...
    while (maxIter-- > 0) {
      step = tickIncrement(start4, stop, count3);
      if (step === prestep) {
        d[i0] = start4;
        d[i1] = stop;
        return domain(d);
...
function timeInterval(floori, offseti, count3, field) {
  ...
  interval3.range = (start4, stop, step) => {
    const range4 = [];
    start4 = interval3.ceil(start4);
    step = step == null ? 1 : Math.floor(step);
    if (!(start4 < stop) || !(step > 0))
      return range4;
    let previous;
    do
      range4.push(previous = /* @__PURE__ */ new Date(+start4)), offseti(start4, step), floori(start4);
  ...
  if (count3) {
    interval3.count = (start4, end) => {
      t02.setTime(+start4), t12.setTime(+end);
...
function ticker(year, month, week, day, hour, minute) {
  ...
  function ticks2(start4, stop, count3) {
    const reverse2 = stop < start4;
    if (reverse2)
      [start4, stop] = [stop, start4];
    const interval3 = count3 && typeof count3.range === "function" ? count3 : tickInterval(start4, stop, count3);
    const ticks3 = interval3 ? interval3.range(start4, +stop + 1) : [];
    return reverse2 ? ticks3.reverse() : ticks3;
  }
  function tickInterval(start4, stop, count3) {
    const target = Math.abs(stop - start4) / count3;
    const i = bisector(([, , step2]) => step2).right(tickIntervals, target);
    if (i === tickIntervals.length)
      return year.every(tickStep(start4 / durationYear, stop / durationYear, count3));
    if (i === 0)
      return millisecond.every(Math.max(tickStep(start4, stop, count3), 1));
...
function arc_default() {
  ...
  function arc() {
    ...
    if (!(r1 > epsilon9))
      ...
      var a01 = a0, a11 = a1, a00 = a0, a10 = a1, da0 = da2, da1 = da2, ap = padAngle.apply(this, arguments) / 2, rp = ap > epsilon9 && (padRadius ? +padRadius.apply(this, arguments) : sqrt3(r0 * r0 + r1 * r1)), rc = min3(abs4(r1 - r0) / 2, +cornerRadius.apply(this, arguments)), rc0 = rc, rc1 = rc, t03, t13;
      if (rp > epsilon9) {
...
function pie_default() {
  var value = identity_default5, sortValues = descending_default, sort2 = null, startAngle = constant_default12(0), endAngle = constant_default12(tau7), padAngle = constant_default12(0);
  function pie(data) {
...
var ENDING2 = 5;
var ENDED2 = 6;
function schedule_default2(node, name, id4, index3, group2, timing) {
  var schedules = node.__transition;
  if (!schedules)
    node.__transition = {};
  else if (id4 in schedules)
...
function tweenRemove2(id4, name) {
  var tween0, tween1;
  return function() {
    var schedule = set5(this, id4), tween = schedule.tween;
    if (tween !== tween0) {
      tween1 = tween0 = tween;
      for (var i = 0, n = tween1.length; i < n; ++i) {
        if (tween1[i].name === name) {
...
function attrTweenNS2(fullname, value) {
  ...
  function tween() {
    var i = value.apply(this, arguments);
    if (i !== i0)
      t03 = (i0 = i) && attrInterpolateNS2(fullname, i);
    return t03;
  }
  tween._value = value;
  return tween;
...
function attrTween2(name, value) {
  ...
  function tween() {
    var i = value.apply(this, arguments);
    if (i !== i0)
      t03 = (i0 = i) && attrInterpolate2(name, i);
    return t03;
  }
  tween._value = value;
  return tween;
...
function durationFunction2(id4, value) {
  return function() {
    set5(this, id4).duration = +value.apply(this, arguments);
  };
}
function durationConstant2(id4, value) {
  return value = +value, function() {
    set5(this, id4).duration = value;
  };
}
...
function easeVarying2(id4, value) {
  return function() {
    var v2 = value.apply(this, arguments);
    if (typeof v2 !== "function")
      throw new Error();
    set5(this, id4).ease = v2;
  };
}
...
function merge_default4(transition4) {
  if (transition4._id !== this._id)
    throw new Error();
  for (var groups0 = this._groups, groups1 = transition4._groups, m0 = groups0.length, m1 = groups1.length, m3 = Math.min(m0, m1), merges = new Array(m0), j = 0; j < m3; ++j) {
    for (var group0 = groups0[j], group1 = groups1[j], n = group0.length, merge2 = merges[j] = new Array(n), node, i = 0; i < n; ++i) {
...
function selectAll_default6(select) {
  ...
  for (var groups2 = this._groups, m3 = groups2.length, subgroups = [], parents = [], j = 0; j < m3; ++j) {
    for (var group2 = groups2[j], n = group2.length, node, i = 0; i < n; ++i) {
      if (node = group2[i]) {
        for (var children4 = select.call(node, node.__data__, i, group2), child, inherit4 = get4(node, id4), k2 = 0, l = children4.length; k2 < l; ++k2) {
          if (child = children4[k2]) {
            schedule_default2(child, name, id4, k2, children4, inherit4);
          }
        }
        subgroups.push(children4);
        parents.push(node);
...
function styleMaybeRemove2(id4, name) {
  var on0, on1, listener0, key = "style." + name, event = "end." + key, remove4;
  return function() {
    var schedule = set5(this, id4), on = schedule.on, listener = schedule.value[key] == null ? remove4 || (remove4 = styleRemove4(name)) : void 0;
    if (on !== on0 || listener0 !== listener)
      (on1 = (on0 = on).copy()).on(event, listener0 = listener);
    schedule.on = on1;
  };
...
function end_default2() {
  ...
  return new Promise(function(resolve, reject) {
    ...
    that.each(function() {
      var schedule = set5(this, id4), on = schedule.on;
      if (on !== on0) {
        on1 = (on0 = on).copy();
        on1._.cancel.push(cancel);
        on1._.interrupt.push(cancel);
...
var id2 = 0;
function Transition2(groups2, parents, name, id4) {
  this._groups = groups2;
  this._parents = parents;
  this._name = name;
  this._id = id4;
...
function transition_default4(name) {
  ...
  for (var groups2 = this._groups, m3 = groups2.length, j = 0; j < m3; ++j) {
    for (var group2 = groups2[j], n = group2.length, node, i = 0; i < n; ++i) {
      if (node = group2[i]) {
        schedule_default2(node, name, id4, i, group2, timing || inherit2(node, id4));
      }
    }
  }
  return new Transition2(groups2, this._parents, name, id4);
}
...
function data_default4(value, key) {
  ...
  if (typeof value !== "function")
    value = constant_default13(value);
  for (var m3 = groups2.length, update = new Array(m3), enter = new Array(m3), exit = new Array(m3), j = 0; j < m3; ++j) {
    var parent = parents[j], group2 = groups2[j], groupLength = group2.length, data = arraylike3(value.call(parent, parent && parent.__data__, j, parents)), dataLength = data.length, enterGroup = enter[j] = new Array(dataLength), updateGroup = update[j] = new Array(dataLength), exitGroup = exit[j] = new Array(groupLength);
    bind(parent, group2, enterGroup, updateGroup, exitGroup, data, key);
    for (var i0 = 0, i1 = 0, previous, next; i0 < dataLength; ++i0) {
      if (previous = enterGroup[i0]) {
        if (i0 >= i1)
...
var nonpassivecapture3 = { capture: true, passive: false };
...
function nodrag_default3(view) {
  var root5 = view.document.documentElement, selection4 = select_default8(view).on("dragstart.drag", noevent_default4, nonpassivecapture3);
  if ("onselectstart" in root5) {
    selection4.on("selectstart.drag", noevent_default4, nonpassivecapture3);
  } else {
    root5.__noselect = root5.style.MozUserSelect;
    root5.style.MozUserSelect = "none";
  }
...
function yesdrag3(view, noclick) {
  ...
  if (noclick) {
    selection4.on("click.drag", noevent_default4, nonpassivecapture3);
    setTimeout(function() {
      selection4.on("click.drag", null);
    }, 0);
  }
...
var emptyOn3 = dispatch_default("start", "end", "cancel", "interrupt");
var emptyTween3 = [];
var CREATED3 = 0;
var SCHEDULED3 = 1;
var STARTING3 = 2;
...
var ENDING3 = 5;
var ENDED3 = 6;
function schedule_default3(node, name, id4, index3, group2, timing) {
  var schedules = node.__transition;
  if (!schedules)
    node.__transition = {};
  else if (id4 in schedules)
...
function tween_default3(name, value) {
  ...
  name += "";
  if (arguments.length < 2) {
    var tween = get5(this.node(), id4).tween;
    for (var i = 0, n = tween.length, t; i < n; ++i) {
      if ((t = tween[i]).name === name) {
        return t.value;
      }
...
function attr_default6(name, value) {
  var fullname = namespace_default3(name), i = fullname === "transform" ? interpolateTransformSvg : interpolate_default4;
...
function attrTweenNS3(fullname, value) {
  ...
  function tween() {
    var i = value.apply(this, arguments);
    if (i !== i0)
      t03 = (i0 = i) && attrInterpolateNS3(fullname, i);
    return t03;
  }
  tween._value = value;
  return tween;
...
function attrTween3(name, value) {
  ...
  function tween() {
    var i = value.apply(this, arguments);
    if (i !== i0)
      t03 = (i0 = i) && attrInterpolate3(name, i);
    return t03;
  }
  tween._value = value;
  return tween;
...
function delay_default3(value) {
  var id4 = this._id;
  return arguments.length ? this.each((typeof value === "function" ? delayFunction3 : delayConstant3)(id4, value)) : get5(this.node(), id4).delay;
}
...
function duration_default3(value) {
  var id4 = this._id;
  return arguments.length ? this.each((typeof value === "function" ? durationFunction3 : durationConstant3)(id4, value)) : get5(this.node(), id4).duration;
}
...
function ease_default3(value) {
  var id4 = this._id;
  return arguments.length ? this.each(easeConstant3(id4, value)) : get5(this.node(), id4).ease;
}

// node_modules/d3-zoom/node_modules/d3-transition/src/transition/easeVarying.js
function easeVarying3(id4, value) {
  return function() {
    var v2 = value.apply(this, arguments);
    if (typeof v2 !== "function")
      throw new Error();
    set6(this, id4).ease = v2;
  };
}
...
function merge_default6(transition4) {
  if (transition4._id !== this._id)
    throw new Error();
  for (var groups0 = this._groups, groups1 = transition4._groups, m0 = groups0.length, m1 = groups1.length, m3 = Math.min(m0, m1), merges = new Array(m0), j = 0; j < m3; ++j) {
    for (var group0 = groups0[j], group1 = groups1[j], n = group0.length, merge2 = merges[j] = new Array(n), node, i = 0; i < n; ++i) {
...
function on_default6(name, listener) {
  var id4 = this._id;
  return arguments.length < 2 ? get5(this.node(), id4).on.on(name) : this.each(onFunction3(id4, name, listener));
}
    ...
    for (var group2 = groups2[j], n = group2.length, subgroup = subgroups[j] = new Array(n), node, subnode, i = 0; i < n; ++i) {
      if ((node = group2[i]) && (subnode = select.call(node, node.__data__, i, group2))) {
        if ("__data__" in node)
          subnode.__data__ = node.__data__;
        subgroup[i] = subnode;
        schedule_default3(subgroup[i], name, id4, i, subgroup, get5(node, id4));
      }
    }
  }
...
function selectAll_default9(select) {
  ...
  for (var groups2 = this._groups, m3 = groups2.length, subgroups = [], parents = [], j = 0; j < m3; ++j) {
    for (var group2 = groups2[j], n = group2.length, node, i = 0; i < n; ++i) {
      if (node = group2[i]) {
        for (var children4 = select.call(node, node.__data__, i, group2), child, inherit4 = get5(node, id4), k2 = 0, l = children4.length; k2 < l; ++k2) {
          if (child = children4[k2]) {
            schedule_default3(child, name, id4, k2, children4, inherit4);
          }
        }
        subgroups.push(children4);
        parents.push(node);
...
function style_default6(name, value, priority) {
  var i = (name += "") === "transform" ? interpolateTransformCss : interpolate_default4;
...
var id3 = 0;
function Transition3(groups2, parents, name, id4) {
  this._groups = groups2;
  this._parents = parents;
  this._name = name;
  this._id = id4;
...
function transition_default6(name) {
  ...
  if (name instanceof Transition3) {
    ...
    id4 = newId3(), (timing = defaultTiming3).time = now(), name = name == null ? null : name + "";
  }
  for (var groups2 = this._groups, m3 = groups2.length, j = 0; j < m3; ++j) {
    for (var group2 = groups2[j], n = group2.length, node, i = 0; i < n; ++i) {
      if (node = group2[i]) {
        schedule_default3(node, name, id4, i, group2, timing || inherit3(node, id4));
      }
    }
  }
  return new Transition3(groups2, this._parents, name, id4);
}
...
function zoom_default2() {
  ...
  function schedule(transition4, transform2, point6, event) {
  ...
  Gesture.prototype = {
    ...
    emit: function(type2) {
      var d = select_default8(this.that).datum();
      listeners.call(
        type2,
        this.that,
        new ZoomEvent(type2, {
  ...
  function mousedowned(event, ...args) {
    if (touchending || !filter5.apply(this, arguments))
      return;
    var currentTarget = event.currentTarget, g = gesture(this, args, true).event(event), v2 = select_default8(event.view).on("mousemove.zoom", mousemoved, true).on("mouseup.zoom", mouseupped, true), p = pointer_default3(event, currentTarget), x06 = event.clientX, y06 = event.clientY;
    nodrag_default3(event.view);
    nopropagation5(event);
  ...
  function dblclicked(event, ...args) {
    ...
    noevent_default5(event);
    if (duration > 0)
      select_default8(this).transition().duration(duration).call(schedule, t13, p02, event);
    else
      select_default8(this).call(zoom.transform, t13, p02, event);
  }
  ...
  zoom.wheelDelta = function(_) {
    return arguments.length ? (wheelDelta = typeof _ === "function" ? _ : constant_default15(+_), zoom) : wheelDelta;
  };
  zoom.filter = function(_) {
    return arguments.length ? (filter5 = typeof _ === "function" ? _ : constant_default15(!!_), zoom) : filter5;
  };
  zoom.touchable = function(_) {
    return arguments.length ? (touchable = typeof _ === "function" ? _ : constant_default15(!!_), zoom) : touchable;
  };
  zoom.extent = function(_) {
    return arguments.length ? (extent2 = typeof _ === "function" ? _ : constant_default15([[+_[0][0], +_[0][1]], [+_[1][0], +_[1][1]]]), zoom) : extent2;
  };
